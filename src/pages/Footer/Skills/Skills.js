        ...
        <div className='my-10' id='skills'>
            ...
            <div className='space-y-3'>
                ...
                <div className=''>
                    ...
                    <input type="range" min="0" max="100" defaultValue="100" className="range w-96 range-primary" />
                </div>
                ...
                <div className=''>
                    ...
                    <input type="range" min="0" max="100" defaultValue="95" className="range w-96 range-primary" />
                </div>

                <div className=''>
                    <p className='text-xl mb-2'>React</p>
                    <input type="range" min="0" max="100" defaultValue="98" className="range w-96 range-primary" />
                </div>
                <div className=''>
                ...
                <div className=''>
                    ...
                    <input type="range" min="0" max="100" defaultValue="90" className="range w-96 range-primary" />
                </div>
                <div className=''>
                ...
                <div className=''>
                    ...
                    <input type="range" min="0" max="100" defaultValue="60" className="range w-96 range-primary" />
                </div>
